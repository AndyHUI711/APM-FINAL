...
but_pin_1 = 19  # BOARD pin 19
but_pin_2 = 21  # BOARD pin 21
...
def human_flow_counting(do_entrance_counting,
	...
	# DOOR
        ...
        GPIO.setup(but_pin_2, GPIO.IN)  # Button pin set as input
	# LINE
        ...
        try:
            ...
            door1 = GPIO.input(but_pin_1)
            door2 = GPIO.input(but_pin_2)
	    # open: 1;   close: 0
...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', nargs='+', type=Path, default=WEIGHTS / 'weights/sf640.engine',
